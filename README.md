...
*4. В случае если вы видите в логах сообщение о том, что база данных запустилась, а приложение завершило свою работу, то остановите контейнеры нажав сочетание клавиш Ctrl + C, затем перезапустите контейнеры командой:
```
docker-compose up
```
